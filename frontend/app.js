...
const names = {
  ...
  effective_available_budget: '本次可用预算', display_occupation: '最终展示预算占用',
  recommended_plan_occupation: '最终推荐方案预算占用',
  minimum_cost_plan_occupation: '最低成本方案预算占用',
  estimated_occupation: 'Budget 原始预计占用（最低成本）',
